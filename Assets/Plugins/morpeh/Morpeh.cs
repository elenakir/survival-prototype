...
namespace Morpeh {
    ...
    public static partial class WorldExtensions {
        ...
        public static void Clear(this World world)
        {
            ...
            {
                if (e.IsNullOrDisposed()) continue;
    ...
    public static class FilterExtensions {
        ...
        public static Filter With<T1, T2>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            => filter
                .CreateFilter<T1>(Filter.Mode.Include)
                .CreateFilter<T2>(Filter.Mode.Include)
            ;
        
        public static Filter With<T1, T2, T3>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            ...
            => filter
                .CreateFilter<T1>(Filter.Mode.Include)
                .CreateFilter<T2>(Filter.Mode.Include)
                .CreateFilter<T3>(Filter.Mode.Include)
            ;
        
        public static Filter With<T1, T2, T3, T4>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            where T3 : struct, IComponent
            ...
            => filter
                ...
                .CreateFilter<T2>(Filter.Mode.Include)
                .CreateFilter<T3>(Filter.Mode.Include)
                .CreateFilter<T4>(Filter.Mode.Include)
        ;

        public static Filter Without<T>(this Filter filter) where T : struct, IComponent
            => filter.CreateFilter<T>(Filter.Mode.Exclude);
        
        public static Filter Without<T1, T2>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            => filter
                .CreateFilter<T1>(Filter.Mode.Exclude)
                .CreateFilter<T2>(Filter.Mode.Exclude)
            ;
        
        public static Filter Without<T1, T2, T3>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            where T3 : struct, IComponent
            => filter
                .CreateFilter<T1>(Filter.Mode.Exclude)
                .CreateFilter<T2>(Filter.Mode.Exclude)
                .CreateFilter<T3>(Filter.Mode.Exclude)
        ;

        public static Filter Without<T1, T2, T3, T4>(this Filter filter)
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            where T3 : struct, IComponent
            where T4 : struct, IComponent
            => filter
                ...
                .CreateFilter<T2>(Filter.Mode.Exclude)
                .CreateFilter<T3>(Filter.Mode.Exclude)
                .CreateFilter<T4>(Filter.Mode.Exclude)
        ;
